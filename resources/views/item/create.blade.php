<form action="{{ route('kendaraan.store') }}" method="POST">
  ...
  <div class="form-group">
    ...
    <input name="nama" type="text" class="form-control" placeholder="Contoh: Avanza 1.5 Veloz" autofocus='true' autocomplete="off">
  </div>
  <div class="form-group">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input name="no_rangka" type="text" class="form-control" autocomplete="off">
    </div>

    <div class="form-group col-md-6">
      <label for="exampleFormControlInput1">No. Plat</label>
      <input name="no_plat" type="text" class="form-control" autocomplete="off">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="exampleFormControlInput1">No. Mesin</label>
      <input name="no_mesin" type="text" class="form-control" placeholder="Contoh: 2NRJHDH39874982VE" autocomplete="off">
    </div>
    <div class="form-group col-md-6">
      <label for="exampleFormControlInput1">Warna</label>
      <input name="warna" type="text" class="form-control" autocomplete="off">
    </div>
  </div>
