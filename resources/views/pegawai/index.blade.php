    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                ...
                <a href="{{ route('pegawai.create') }}" class="btn btn-sm btn-success modal-show" >New User</a>
                ...
                <table id="myTable" class='table'>
                    ...
                    <tr>
                        ...
                        <td class="d-flex flex-row">
                            ...
                            <a href="{{ route('pegawai.kendaraan',$r->id) }}" class="btn btn-primary btn-sm ">kendaraan</a>
                            </form>
                        </td>
